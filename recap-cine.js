/* =========================================================
   WOOO Ciné — Recap des votes (avant validation)
   ---------------------------------------------------------
   Identique à recap.js mais :
   - Pas de play/pause sur les chansons
   - Cover rectangulaire (poster) côté CSS via [data-product]
   - Redirige vers guess-cine.html / classement.html
   ========================================================= */

(function () {
  'use strict';

  console.log('[Wooo recap-cine.js] version 6 chargée ✅');
  ...
  btnNext.addEventListener('click', async () => {
    ...
    try {
      ...
      if (themeIndex + 1 < totalThemes) {
        // Thème suivant
        window.location.href = 'guess-cine.html?theme=' + (themeIndex + 1);
      } else {
  ...
  btnBack.addEventListener('click', () => {
    window.location.href = 'guess-cine.html?theme=' + themeIndex;
  });
